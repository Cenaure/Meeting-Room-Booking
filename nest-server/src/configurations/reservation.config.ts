...
export default registerAs("reservation", () => {
  return validateConfig(
    {
      prevent_cancellation_before_minutes: parseInt(process.env.PREVENT_CANCELLATION_BEFORE_MINUTES!, 10) || 15,
      notify_before_minutes: parseInt(process.env.NOTIFY_BEFORE_MINUTES!, 10) || 10,
    },
