...
describe('ReservationsService', () => {
  ...
  const notificationSchedulerService = {
    scheduleReservationEndingNotification: jest.fn(),
  };
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: notificationSchedulerService,
        },
        {
  ...
  describe('create reservation', () => {
    ...
    it('should throw an error if the user is not found', async () => {
      ...
      await expect(service.createReservation(1, reservation)).rejects.toThrow(
    ...
    describe('time validation tests', () => {
      beforeEach(() => {
        jest
          ...
          .mockImplementation(() => 'Europe/Kyiv');
    ...
    describe('queue behavior test', () => {
      ...
      it('should enqueue a job', async () => {
        ...
        expect(mockQueue.add).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            ...reservation,
            user: { id: 1, username: 'cenaure' },
          }),
          expect.objectContaining({
            jobId: expect.stringContaining(`${reservation.room_id}_`),
          }),
        );
      });
      ...
      it('should throw a conflict error if the room is already booked for this time', async () => {
        ...
        await expect(
          service.createReservation(1, reservation),
        ).rejects.toMatchObject({
          response: expect.objectContaining({
